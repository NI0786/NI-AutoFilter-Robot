...
USERNAME = environ.get('USERNAME', "https://t.me/IM_NISHANTT") # ADMIN USERNAME
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002287323098').split()]
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002469842447')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '0'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002386346176')
request_channel = environ.get('REQUEST_CHANNEL', '-4554257154') # If anyone sends a request message to your bot, you will get it in this channel.
